...
public class Startup extends javax.swing.JFrame {
    ...
    public Startup() throws SQLException {
        ...
        initComponents();
        Image i = t.getImage("admin.png").getScaledInstance(40,40, Image.SCALE_SMOOTH);
        ImageIcon im = new ImageIcon(i);
        ad.setIcon(im);
        i=t.getImage("student.png").getScaledInstance(40,40, Image.SCALE_SMOOTH);
        im=new ImageIcon(i);
        ad1.setIcon(im);
        i=t.getImage("book.png").getScaledInstance(40,40, Image.SCALE_SMOOTH);
        im=new ImageIcon(i);
        book.setIcon(im);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try
                {
                    ...
                    obj.setIconImage(new ImageIcon("library.png").getImage());
                    obj.setVisible(true);
                }
                catch(Exception e)
                {
